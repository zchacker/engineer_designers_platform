...
Route::get('/{id}/services/details', [\App\Http\Controllers\Public\PagesController::class, 'services_details'])->name('services.details');
Route::get('/{id}/services/details/{name}', function ($id, $name) {
    return redirect('/' . $id . '/services/details', 301);
});
...
Route::get('/blog/post/{id}', [\App\Http\Controllers\Public\BlogController::class, 'post'])->name('blog.post');
// Route::get('/blog/post/{id}/{title}', function ($id, $title) {
//   return redirect('/blog/post/' . $id, 301);
// });
...
Route::group(['prefix' => '{locale?}', 'where' => ['locale' => 'en|ar']], function () {
    ...
    Route::get('/services', [\App\Http\Controllers\Public\PagesController::class, 'services'])->name('services');
    Route::get('/services/details/{id}/{name?}', [\App\Http\Controllers\Public\PagesController::class, 'services_details'])->name('services.details');
    Route::get('/{id}/services/details/{name?}', [\App\Http\Controllers\Public\PagesController::class, 'services_details'])->name('services.details');
