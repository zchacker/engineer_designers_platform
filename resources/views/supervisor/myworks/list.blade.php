                        ...
                        <div class="mt-8 flex flex-col">
                            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            ...
                                            <tr>
                                                ...
                                                <td class="relative flex justify-between whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 md:pr-0">
                                                    <a href="{{  route('supervisor.my.work.details' , $work->id)  }}" class="text-gray-600 hover:text-gray-900" title="Download File">
                                                    ...
                                                    <form action="{{ route('supervisor.my.work.delete', $work->id) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                    ...
                                    @else
                                    <p>
                                        {!! __('empty_work_list' , ['work_btn' => "<a href='" . route(' supervisor.my.work.create') . "'  class='font-sans text-blue-600 hover:text-blue-500'>" . __('create_work') . "</a>" ] ) !!} </p>
                                    @endif
                                </div>
                            </div>
                        </div>
