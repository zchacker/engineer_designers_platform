            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="relative rounded-tl-md  rounded-tr-md overflow-auto">
                    <div class="overflow-x-auto relative p-2">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('supervisor.meeting.create.action' , $client_id) }}" id="file-upload-form">
                            @csrf
                ...
                <div class="relative rounded-tl-md min-h-[50vh]  rounded-tr-md overflow-auto">
                    ...
                    <a href="{{route('supervisor.google.request.token')}}" class="normal_button my-8">{{__('meeting_permission_garant')}}</a>
                </div>
                @endif
            </div>
        </div>
