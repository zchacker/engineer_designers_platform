...
<body style="background-color: #f4f4f4;">
    <div style="background-image: url('{{asset('imgs/image/head-pages.webp')}}');  background-size: cover; background-position: center; max-width: 600px; margin: 0 auto; text-align: center;">
