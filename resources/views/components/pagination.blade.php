@if ($paginator->hasPages())
    <div class="flex items-center">
        ...
        @else
            <a
                class="rounded-r rounded-sm border-t border-b border-r border-brand-light px-3 py-2 text-brand-dark hover:bg-brand-light no-underline"
        ...
        @if ($paginator->hasMorePages())
            <a class="rounded-l rounded-sm border border-brand-light px-3 py-2 hover:bg-brand-light text-brand-dark no-underline" href="{{ $paginator->nextPageUrl() }}" rel="next">&raquo;</a>
        @else
            <span class="rounded-l rounded-sm border border-brand-light px-3 py-2 hover:bg-brand-light text-brand-dark no-underline cursor-not-allowed">&raquo;</span>
        @endif
    </div>
@endif