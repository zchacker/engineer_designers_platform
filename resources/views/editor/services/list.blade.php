                    ...
                    <div class="px-4 sm:px-0 lg:px-0">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                <a href="{{ route('editor.services.create') }}" class="normal_button">
                                    {{__('service_create')}}
                                </a>
                            </div>
                        </div>
                                    ...
                                    <tbody class="table_body">
                                        ...
                                        <tr data-href="" class="clickable-row cursor-pointer hover:bg-gray-200">
                                            ...
                                            <td class="relative flex gap-4 justify-between whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 md:pr-0">
                                                ...
                                                <a href="{{ route('editor.services.edit' , $service->id) }}" class="text-blue-600 hover:text-blue-900" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                    </svg>
                                                </a>

                                                <form action="{{ route('editor.services.delete', $service->id) }}" method="POST" onsubmit="return confirmDelete()">
                                                    @method('DELETE')
                                                    @csrf
...
<script>
    function confirmDelete() {
        return confirm(" {{__('service_delete_confirmation')}} ");
    }
</script>
