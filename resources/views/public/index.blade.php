@include('public.header')
        ...
        <div class="container max-w-screen-xl mx-auto px-4">
            ...
            <div class="flex items-center justify-center xl:justify-start">
                ...
                <div class="mt-28 text-center xl:text-right z-20">
                    <h1 class="font-semibold text-4xl md:text-6xl lg:text-7xl text-gray-900 leading-normal mb-6">{!! __('public')['hero_msg'] !!}</h1>

                    <p class="font-normal text-xl text-gray-400 leading-relaxed mb-12">{{__('public')['sub_hero']}}</p>

                    <a href="{{ route('register.user') }}" class="px-6 py-4 bg-green-700 text-white font-semibold text-lg rounded-xl hover:bg-green-900 transition ease-in-out duration-500">{{__('public')['start_now']}}</a>
                </div>

                <div class="hidden xl:block xl:absolute z-0 top-0 left-0">
                    <img src="{{asset('imgs/image/home-img.png')}}" alt="Home img">
                </div>
    ...
    <!-- feature section -->
    <section class="bg-gray-100 py-10 md:py-16 xl:relative">

        <div class="container max-w-screen-xl mx-auto px-4">

            <div class="flex flex-col xl:flex-row justify-start">

                <div class="hidden2 xl:block right-0 bottom-0 w-auto xl:ml-8 xl:-mt-14">
                    <img src="{{asset('imgs/image/feature-img.png')}}" alt="Feature img">
                </div>

                <div class="xl:w-1/2 mt-14">

                    <h1 class="font-semibold text-gray-900 text-xl md:text-4xl text-right leading-normal mb-6">{{__('public')['get_know_us']}}</h1>

                    <p class="font-normal text-gray-400 text-md md:text-xl text-justify mb-16">{{__('public')['about_message']}}</p>
                    ...
                    <div class="flex flex-col md:flex-row-reverse justify-center xl:justify-start space-x-4 mb-20">
                        ...
                        <div class="text-center md:text-right">
                            <h4 class="font-semibold text-gray-900 text-2xl mb-2">{{__('public')['vision']}}</h4>
                            <p class="font-normal text-gray-400 text-xl leading-relaxed text-justify">{{__('public')['vision_details']}}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col md:flex-row-reverse justify-center xl:justify-start space-x-4 mb-20">
                        ...
                        <div class="text-center md:text-right">
                            <h4 class="font-semibold text-gray-900 text-2xl mb-2">{{__('public')['mission']}}</h4>
                            <p class="font-normal text-gray-400 text-xl leading-relaxed text-justify">{{__('public')['mission_details']}}</p>
                        </div>
                    </div>
    ...
    <section class="bg-white py-10 md:py-16">
        ...
        <h2 class="font-bold text-3xl text-center my-9" >{{__('public')['services']}}</h2>

        <div class="container grid grid-cols-4 space-x-6 max-w-screen-xl mx-auto px-4">

            <div class="flex-col text-center justify-center space-x-4 mb-20 mx-4 bg-green-50 p-4 rounded-lg">
    ...
    <section class="bg-white py-10 md:py-16">
        ...
        <div class="container max-w-screen-xl mx-auto px-4 xl:relative">
            ...
            <div class="grid grid-cols-2 gap-8 mt-32 md:items-center justify-center md:space-x-8 lg:space-x-12 mb-10 md:mb-20">
        ...
        <div class="container max-w-screen-xl mx-auto px-4 xl:relative">
            ...
            <div class="bg-green-800 flex flex-col lg:flex-row items-center justify-evenly py-14 rounded-3xl">
                ...
                <div class="hidden md:block bg-white xl:relative px-6 py-3 rounded-3xl">
                    ...
                    <div class="py-3">
                        <input type="text" placeholder="{{__('name')}}" class="px-4 py-4 w-96 bg-gray-100 placeholder-gray-400 rounded-xl outline-none">
                    </div>

                    <div class="py-3">
                        <input type="text" placeholder="{{__('email')}}" class="px-4 py-4 w-96 bg-gray-100 placeholder-gray-400 rounded-xl outline-none">
                    </div>

                    <div class="py-3 relative">
                        <input type="date" placeholder="{{__('date')}}" class="px-4 py-4 w-96 bg-gray-100 font-normal text-lg placeholder-gray-400 rounded-xl outline-none">
                    ...
                    <div class="py-3 relative">
                        <input type="text" placeholder="{{__('notes')}}" class="px-4 py-4 w-96 bg-gray-100 placeholder-gray-400 rounded-xl outline-none">
