                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                <a href="{{ route('client.engineers.list') }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto">
                                    {{__('create_order')}}
                                </a>
                            </div>
                        </div>
                                                ...
                                                @foreach($orders as $order)
                                                    <tr>                                                        
                                                        ...
                                                        <td class="relative flex justify-between whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 md:pr-0">
                                                            <a href="{{ route('client.order.details' , $order->id ) }}" class="text-gray-600 hover:text-gray-900" title="View">
