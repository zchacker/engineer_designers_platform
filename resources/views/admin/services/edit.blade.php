...
<div class="content">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-transparent overflow-hidden shadow-sm sm:rounded-lg">
                <div class="relative rounded-tl-md  rounded-tr-md overflow-auto p-8">
                    <h2 class="text-2xl font-bold mb-4"> {{__('service_edit')}} </h2>
                    <div class="overflow-x-auto relative">
                        ...
                        <form action="{{ route('admin.services.edit.action', $service->id) }}" method="post" enctype="multipart/form-data" onsubmit="return form_submit(this);" class="w-full">
                            @csrf
    ...
    <script>
        function checkFileSize(fileInput) {
            ...
            if (fileSize > 0.2 * 1024 * 1024) { // 1 MB in bytes
                alert("حجم الصورة تخطى 1MB الرجاء إختيار صورة أقل حجماً");
