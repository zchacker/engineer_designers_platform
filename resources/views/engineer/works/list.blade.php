                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                <a href="{{ route('engineer.work.create') }}" class="inline-flex items-center justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 sm:w-auto">
                                    {{__('create_work')}}
                                </a>
                            </div>                            
                        </div>
                        ...
                        <div class="mt-8 flex flex-col">
                            <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                                ...
                                                @foreach($works as $work)
                                                    <tr>                                                        
                                                        ...
                                                        <td class="relative flex justify-between whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 md:pr-0">
                                                            <a href="{{  route('engineer.work.details' , $work->id)  }}" class="text-gray-600 hover:text-gray-900" title="Download File">
                                                            ...
                                                            <form action="{{ route('engineer.work.delete', $work->id) }}" method="POST" onsubmit="confirmDelete(event)">
                                                                @method('DELETE')
                                                                @csrf
                                    ...
                                    @else
                                        <p>
                                            {!! __('empty_work_list' , ['work_btn' => "<a href='" . route('engineer.work.create') . "'  class='font-sans text-blue-600 hover:text-blue-500'>" . __('create_work') . "</a>" ] ) !!}
                                        </p>
                                    @endif
                                </div>
                            </div>
