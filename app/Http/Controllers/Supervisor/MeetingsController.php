...
class MeetingsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return view('supervisor.meetings.list', compact('meetings', 'sum'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('supervisor.meetings.create', compact('client_id', 'user', 'valid_token'));
    }
    ...
    public function redirectToGoogle()
    {
        return Socialite::driver('google')
            ...
            ->with(["access_type" => "offline", "prompt" => "consent"]) //, "prompt" => "consent select_account"])
            ->redirect();
    }
    ...
    public function handleGoogleCallback(Request $request)
    {
        ...
        $user_data = UsersModel::where(['id' => $request->user()->id])->first();
