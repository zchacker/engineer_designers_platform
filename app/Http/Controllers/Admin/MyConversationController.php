...
class MyConversationController extends Controller
{
    ...
    public function initiateConversation(Request $request)
    {
        ...
        if ($existingConversation) {
            ...
            return redirect()->route('admin.my.conversation.view', ['conversationId' => $existingConversation]);
        }
        ...
        return redirect()->route('admin.my.conversation.view', ['conversationId' => $conversationId]);
    }
    ...
    public function listConversations()
    {
        ...
        return view('admin.conversations.my.list', compact('conversations'));
    }
    ...
    public function viewConversation($conversationId)
    {
        ...
        return view('admin.conversations.my.view', compact('conversation', 'messages', 'otherUser', 'myUser'));
    }
